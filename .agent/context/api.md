...
**PRIMARY DIRECTIVE:** You are the interface. You ONLY have write access to `src/efficient_tutor_backend/api/` and `src/efficient_tutor_backend/main.py`.
...
* **Modern Syntax:** Use standard modern Python type hinting (e.g., `str | None` instead of `Optional[str]`).
